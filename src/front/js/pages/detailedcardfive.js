              ...
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item">
                  <a
                    ...
                    href="#"
                  >
                    E-Skateboard-Spotlight Edition
                  </a>
                </li>
              </ol>
            </nav>
            <div className="row align-items-center mb-24 mb-lg-52">
              <div className="col-12 col-lg-4 mb-10 mb-lg-0">
                ...
                <p className="mw-md text-secondary">
                  Rent out the Electrical Skateboard Spotlight Edition to learn
                  E-Skatint the classic way, in just 10-15 min you will have
                  figured out how to ride with your E-Skate alongside Miami's
                  beautiful Streets{" "}
                </p>
              </div>
              ...
              onClick={() => {
                if (store.isLogin) {
                  actions.updateCart({
                    ...
                    skateboard_type: "E-Skateboard-Spotlight Edition",
                    image:
                      "https://static.shuffle.dev/uploads/files/f3/f3a7e512c9216c316e6bdb267d859cb3b15861dd/maxresdefault.jpg",
