            ...
            <div className="row align-items-center mb-24 mb-lg-52">
              <div className="col-12 col-lg-4 mb-10 mb-lg-0">
                ...
                <p className="mw-md text-secondary">
                  Rent out the Electrical Skateboard Rainbow Edition to enjoy on
                  of our very special E-skateboard varients. With the provided
                  colorful lights, riding your E-skateboard at night becomes an
                  even more exciting activity{" "}
                </p>
              </div>
              ...
              onClick={() => {
                if (store.isLogin) {
                  actions.updateCart({
                    ...
                    skateboard_type: "E-Skateboard-Rainbow Edition",
                    image:
                      "https://static.shuffle.dev/uploads/files/f3/f3a7e512c9216c316e6bdb267d859cb3b15861dd/xtnd-electric-skateboard-00.jpg",
