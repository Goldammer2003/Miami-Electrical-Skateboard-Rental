  ...
  return (
	...
	<nav className="relative flex justify-between items-center">
	  ...
	  <a className="text-2xl text-white font-bold" href="#">
		<img className="h-7" src="https://th.bing.com/th/id/OIP.VrrYe-vszA0TcDwQhI1mPAHaCi?pid=ImgDet&rs=1" alt="" width="auto">
	  </a>
	  ...
	  <div className="hidden lg:block ml-auto mr-16">
		<ul className="flex items-center text-white space-x-10">
		  <li><a className="text-white font-bold text-lg" href="#">Product</a></li>
		  <span>
		  ...
		  <li><a className="text-white font-bold text-lg" href="#">Story</a></li>
		  <span>
			<svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="2.5" cy="2.5" r="2.5" fill="#726B6B"></circle></svg>
		  </span>
		  <li><a className="text-white font-bold text-lg" href="#">Features</a></li>
		  <span>
			<svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="2.5" cy="2.5" r="2.5" fill="#726B6B"></circle></svg>
		  </span>
	  ...
	  <div className="hidden lg:block"><a className="inline-block px-12 py-4 text-white font-bold border border-gray-200 hover:border-white rounded-full" href="#">Sign Up</a></div>
	</nav>
	<div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
	  ...
	  <nav className="relative flex flex-col py-8 h-full w-full bg-white overflow-y-auto">
		...
		<div>
		  <ul>
			<li className="mb-1 px-10"><a className="block pl-8 py-4 text-xl text-gray-800 hover:bg-blueGray-50 rounded-xl" href="#"> Products</a></li>
			<li className="mb-1 px-10"><a className="block pl-8 py-4 text-xl text-gray-800 hover:bg-blueGray-50 rounded-xl" href="#">Our history</a></li>
			<li className="mb-1 px-10"><a className="block pl-8 py-4 text-xl text-gray-800 hover:bg-blueGray-50 rounded-xl" href="#">Mentorship</a></li>
